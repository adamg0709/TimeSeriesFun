...
# Should set the lag so that it corresponds to the number of samples that are taken within a 6-month period.
lag = 15
...
confidence_level = 0.05 # p-values under this value imply granger causality

# Generate weights using the p-values
weight_XY = 0
weight_YX = 0

if p_value_XY < confidence_level:
    weight_XY = (confidence_level - p_value_XY)/confidence_level
    
if p_value_YX < confidence_level:
    weight_YX = (confidence_level - p_value_YX)/confidence_level
